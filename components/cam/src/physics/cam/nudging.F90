...
!     Nudge_Ustep(:ncol,pver-1:pver,lchnk) =0._r8
!     Nudge_Vstep(:ncol,pver-1:pver,lchnk) =0._r8
!     Nudge_Tstep(:ncol,pver-1:pver,lchnk) =0._r8
!     Nudge_Qstep(:ncol,pver-1:pver,lchnk) =0._r8
     phys_tend%u(:ncol,:pver-2)     =Nudge_Ustep(:ncol,:pver-2,lchnk) !PMA
     phys_tend%v(:ncol,:pver-2)     =Nudge_Vstep(:ncol,:pver-2,lchnk) !PMA
     phys_tend%s(:ncol,:pver-2)     =Nudge_Tstep(:ncol,:pver-2,lchnk) !PMA
     phys_tend%q(:ncol,:pver-2,indw)=Nudge_Qstep(:ncol,:pver-2,lchnk) !PMA
