...
!$OMP END PARALLEL
    ...
    call addfld ('CLOUDCOVER_AST', (/ 'ilev' /), 'A', 'fraction', 'Stratiform Cloud Fraction')
    call addfld ('CLOUDCOVER_AIST', (/ 'ilev' /), 'A', 'fraction', 'Stratiform Ice Cloud Fraction')
    call addfld ('CLOUDCOVER_ALST', (/ 'ilev' /), 'A', 'fraction', 'Stratiform Liquid Cloud Fraction')   
    ...
    call addfld ('DEEPCU', (/ 'lev' /),  'A',        'fraction', 'Convective cloud cover')
...
!PMA gustiness output fields
    ...
    if (history_clubb) then
       ...
       call add_default('CLOUDCOVER_AST', 1, ' ')
       call add_default('CLOUDCOVER_ALST', 1, ' ')
       call add_default('CLOUDCOVER_AIST', 1, ' ')
...
!PMA adds gustiness and tpert
   ...
   call outfld( 'CLOUDCOVER_AST', ast,              pcols, lchnk )
   call outfld( 'CLOUDCOVER_AIST', aist,              pcols, lchnk )
   call outfld( 'CLOUDCOVER_ALST', alst,              pcols, lchnk )
